...
<body>
	...
	<div class="container" id = "recent">
		<h3 class= "text-center pt-3">Search Result</h3>
		<div class="row cd">
			  ...
			  <%
			  	...
			  	String sstring = request.getParameter("search");
				...
				String uid = "";
			  	...
			  	List<BookDet> list = bdi.getSearchBooks(sstring);
			  	for(BookDet bdt: list){
			  		String add = "login.jsp";
				  	if(user != null){
				  		add = "CartServ?id=" +bdt.getBookID()+uid +"&pg=search"; 
				  	}
			  %>
